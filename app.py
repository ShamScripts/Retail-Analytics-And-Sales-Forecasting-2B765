...
if selected == "Dashboard":
    ...
    with dashboard_tabs[0]:
        ...
        with tab1:
            st.plotly_chart(create_mrp_plot(df), use_container_width=True)
        
        with tab2:
            st.plotly_chart(create_outlet_size_plot(df), use_container_width=True)
        
        with tab3:
            st.plotly_chart(create_outlet_type_plot(df), use_container_width=True)
